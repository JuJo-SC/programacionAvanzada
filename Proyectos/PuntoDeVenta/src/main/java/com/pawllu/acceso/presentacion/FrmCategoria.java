...
import com.pawllu.negocio.CategoriaControl;
...
public class FrmCategoria extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtDescripcion.getText().trim().length() == 0 || txtDescripcion.getText().trim().length() > 25) {
            descripcion = "-";
        } else {
        ...
        if (accion.equals("editar")) {
            //editar
            resp = CONTROL.actualizar(Integer.parseInt(txtId.getText().trim()), txtNombre.getText().trim(), nombreAnterior, descripcion);
            if (resp.equals("OK")) {
            ...
            //guardar
            resp = CONTROL.insertar(Integer.parseInt(txtId.getText().trim()), txtNombre.getText().trim(), descripcion);
            if (resp.equals("OK")) {
