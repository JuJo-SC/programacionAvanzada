...
public class ControladorPrincipal implements ActionListener {
    ...
    private void cargarDatosIniciales() {
        int respuesta = JOptionPane.showConfirmDialog(contexto.getVistaPrincipal(),
            "¿Cargar los 69 productos de Surti-Tienda en 9 categorías?\n\n" +
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(contexto.getVistaPrincipal(),
                    "✓ Datos de Surti-Tienda cargados exitosamente\n\n" +
                    "Total productos agregados: " + agregados + "\n\n" +
                    "9 Categorías de Surti-Tienda:\n" +
                    "1. Despensa Básica\n" +
                    "2. Lácteos y Huevo\n" +
                    "3. Bebidas y Líquidos\n" +
                    "4. Botanas y Dulces\n" +
                    "5. Frutas y Verduras\n" +
                    "6. Carnes y Salchichonería\n" +
                    "7. Cuidado del Hogar\n" +
                    "8. Higiene y Cuidado Personal\n" +
                    "9. Alimentos Preparados/Enlatados",
