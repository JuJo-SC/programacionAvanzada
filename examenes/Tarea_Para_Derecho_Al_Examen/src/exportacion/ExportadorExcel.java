...
public class ExportadorExcel {
    ...
    public static String exportarProductos(ArrayList<Producto> productos) {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(ruta))) {
            // Cabecera
            pw.println("ID,SKU,Código,Nombre,Categoría,Tipo,Unidad,P.Compra,P.Venta,% Ganancia,Stock,Stock Mín,Activo,Imagen");
            ...
            for (Producto p : productos) {
                ...
                pw.print(p.getPorcentajeGanancia() + "%,");
                pw.print(p.getStock() + ",");
    ...
    public static String exportarProductosPorCategoria(ArrayList<Producto> productos) {
        ...
        for (Map.Entry<String, ArrayList<Producto>> entry : porCategoria.entrySet()) {
            ...
            try (PrintWriter pw = new PrintWriter(new FileWriter(ruta))) {
                pw.println("ID,SKU,Código,Nombre,Tipo,Unidad,P.Venta,% Ganancia,Stock,Activo");
