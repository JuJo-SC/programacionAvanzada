...
public class VistaProductosInternal extends JInternalFrame {
    ...
    public final JTextField txtPorcentajeGanancia;
    ...
    public VistaProductosInternal() {
        ...
        panelFormulario.add(new JLabel("% Ganancia:"), gf);
        txtPorcentajeGanancia = new JTextField(10);
        gf.gridx = 1;
        panelFormulario.add(txtPorcentajeGanancia, gf);

        gf.gridx = 0; gf.gridy = 7;
        panelFormulario.add(new JLabel("Precio Venta (calculado):"), gf);
